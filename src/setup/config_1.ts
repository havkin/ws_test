export const config_1 = {
  moderator: {
    user_init: {"type":"user_init","data":{"id":"606e9129e00a6222bc87a3ee"}},
    room_check: {"type":"room_check","data":{"roomName":"/"}},
    player_data: {"type":"player_data","data":{"liarsToken":"eyJhbGciOiJIUzI1NiJ9.c29tYXhAa20ucnU.GMBL-NiO4uQ02OLK47wpT4KnY6ncXyWwU9mmMYggTZc","JID":"7285327c","bareJid":"7285327c-728b-4abc-84d9-3c1c9414b584@warp.liars.club/4f4e0e8d-6b18-49bc-a5ad-ff59daeaeb14","avatarLink":"profile_images/po2no9puyjv6pwtwrfpy","isModerator":false,"name":"Max Havkin","room":"kn8wehe0"}},
